...
function HomeCategoryComponent(props: MenuItemProps): JSX.Element {
	...
	return (
		<button
			...
			className={`group menu-item min-w-30-perc flex-auto h-60 flex justify-center 
                cursor-pointer items-center border mt-0 relative overflow-hidden`}
		...
		>
			...
			<div className='content border border-gray-700 p-5 bg-gray-100 bg-opacity-60 hover:bg-opacity-80 transition z-10'>
				<h1 className='title font-bold'>{title.toUpperCase()}</h1>
